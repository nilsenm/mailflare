...
export function LoginClient() {
    ...
    try {
      ...
      setError(
        error instanceof DOMException && error.name === "TimeoutError"
          ...
          : "No se pudo conectar con el servicio de inicio de sesión. Inténtalo de nuevo.",
      );
      setTurnstileReset((value) => value + 1);
    } finally {
      setLoading(false);
  ...
  async function onSubmitCode(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setError("No se pudo conectar con el servicio de inicio de sesión. Inténtalo de nuevo.");
    } finally {
      setLoading(false);
    }
  }
  ...
  if (challengeToken) {
    return (
      <AuthShell
        ...
        description="Ingresa el código de 6 dígitos de tu aplicación de autenticación o uno de tus códigos de recuperación."
      >
  ...
  return (
    <AuthShell
      ...
      description="Abre tu buzón y continúa desde el mismo espacio de la bandeja de entrada."
    >
